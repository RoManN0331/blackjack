...
public class CardCounter {
    ...
    public CardCounter(Endpoint dealer, int hostport) {
        ...
        try (DatagramSocket socket = new DatagramSocket()){
            ...
            Message message = new Message(host, dealer, "get_decks", "");
        ...
        System.out.println("Counting cards and for requests on "+host.ip+":"+host.port);
        listen(12345);
    }
    ...
    public void updateCount(String card){
        ...
        if (deckCount > 0) {
            trueCardCount = runningCardCount / deckCount;
        }
    }
    ...
    public String provideStats(String player){
        ...
        ("Statistics: Wins: " +  stat.wins +
         "\nLosses: " + stat.losses +
         "\nBlackjacks: " + stat.blackjacks);
    }
    ...
    public static void main(String[] args) {
        ...
        try { 
            ...
            System.out.println("Specify the port number for the card counter (Default: 12345):");
            String port = reader.readLine();
            if (port.isBlank()) port = "12345";
            new CardCounter(new Endpoint(dealer[0], Integer.parseInt(dealer[1])), Integer.parseInt(port));            
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
